...
class Turn(models.Model):
    ...
    created_by=models.CharField(max_length=100, blank=True, null=True, default="", help_text="Username who requested this turn")
    created_at=models.DateTimeField(auto_now_add=True)
    finished_at=models.DateTimeField(null=True, blank=True)
    scheduled_for=models.DateTimeField(null=True, blank=True, help_text="Date/time for rescheduled turn")
